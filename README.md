...
awk '{if ($2 == 1) print $0;}' combined_teosinte.txt | sort -k3,3n > teosinte_chr1_pt1.txt
awk '{if ($2 == 2) print $0;}' combined_teosinte.txt | sort -k3,3n > teosinte_chr2_pt1.txt
awk '{if ($2 == 3) print $0;}' combined_teosinte.txt | sort -k3,3n > teosinte_chr3_pt1.txt
awk '{if ($2 == 4) print $0;}' combined_teosinte.txt | sort -k3,3n > teosinte_chr4_pt1.txt
awk '{if ($2 == 5) print $0;}' combined_teosinte.txt | sort -k3,3n > teosinte_chr5_pt1.txt
awk '{if ($2 == 6) print $0;}' combined_teosinte.txt | sort -k3,3n > teosinte_chr6_pt1.txt
awk '{if ($2 == 7) print $0;}' combined_teosinte.txt | sort -k3,3n > teosinte_chr7_pt1.txt
awk '{if ($2 == 8) print $0;}' combined_teosinte.txt | sort -k3,3n > teosinte_chr8_pt1.txt
awk '{if ($2 == 9) print $0;}' combined_teosinte.txt | sort -k3,3n > teosinte_chr9_pt1.txt
awk '{if ($2 == 10) print $0;}' combined_teosinte.txt | sort -k3,3n > teosinte_chr10_pt1.txt
```
...
awk '{if ($2 == 1) print $0;}' combined_teosinte_sub.txt | sort -k3,3nr > teosinte_chr1_pt2.txt
awk '{if ($2 == 2) print $0;}' combined_teosinte_sub.txt | sort -k3,3nr > teosinte_chr2_pt2.txt
awk '{if ($2 == 3) print $0;}' combined_teosinte_sub.txt | sort -k3,3nr > teosinte_chr3_pt2.txt
awk '{if ($2 == 4) print $0;}' combined_teosinte_sub.txt | sort -k3,3nr > teosinte_chr4_pt2.txt
awk '{if ($2 == 5) print $0;}' combined_teosinte_sub.txt | sort -k3,3nr > teosinte_chr5_pt2.txt
awk '{if ($2 == 6) print $0;}' combined_teosinte_sub.txt | sort -k3,3nr > teosinte_chr6_pt2.txt
awk '{if ($2 == 7) print $0;}' combined_teosinte_sub.txt | sort -k3,3nr > teosinte_chr7_pt2.txt
awk '{if ($2 == 8) print $0;}' combined_teosinte_sub.txt | sort -k3,3nr > teosinte_chr8_pt2.txt
awk '{if ($2 == 9) print $0;}' combined_teosinte_sub.txt | sort -k3,3nr > teosinte_chr9_pt2.txt
awk '{if ($2 == 10) print $0;}' combined_teosinte_sub.txt | sort -k3,3nr > teosinte_chr10_pt2.txt
```
